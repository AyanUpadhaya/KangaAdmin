      ...
      <table className="table w-full table-pin-rows table-pin-cols ">
        ...
        <tbody v-if="currentRows.length > 0">
          ...
          >
            ...
            <td class="py-3">
              <img :src="agent?.image" class="w-10 h-10 rounded-md" alt="" />
            </td>
            <td
              class="py-3 text-black-medium-emp text-base font-normal font-poppins"
            >
              {{
            ...
            <td
              class="py-3 text-black-medium-emp text-base font-normal font-poppins capitalize"
            >
              {{ agent?.role }}
            </td>
            <td
            ...
            >
              <button type="button" @click="handleNavigate(agent)">
                ...
                >
                  <path
                    d="M20 23.0013H4C2.9 23.0013 2 22.1013 2 21.0013C2 19.9013 2.9 19.0013 4 19.0013H20C21.1 19.0013 22 19.9013 22 21.0013C22 22.1013 21.1 23.0013 20 23.0013ZM13.06 4.19128L16.81 7.94128L8.04 16.7113C7.86 16.9013 7.6 17.0013 7.34 17.0013H5C4.45 17.0013 4 16.5513 4 16.0013V13.6613C4 13.3913 4.11 13.1413 4.29 12.9513L13.06 4.19128ZM17.88 6.87128L14.13 3.12128L15.96 1.29128C16.35 0.901279 16.98 0.901279 17.37 1.29128L19.71 3.63128C20.1 4.02128 20.1 4.65128 19.71 5.04128L17.88 6.87128Z"
                    fill="#F2C963"
                  />
                </svg>
              </button>
              <label
                @click="() => setagentId(agent._id)"
...
export default {
  ...
  methods: {
    ...
    handleDelete() {
      this.$store.dispatch("deleteagent", { id: this.agentId });
    },
    handleNavigate(item) {
      this.$router.push(`/agent-edit/:${item._id}`);
    },
