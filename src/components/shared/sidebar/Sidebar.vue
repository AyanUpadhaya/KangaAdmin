<template>
  <div
    class="bg-white h-full duration-300 p-4 sidebar shrink-0 no-scrollbar overflow-hidden select-none"
    :class="showSidebar ? 'w-[272px]' : 'w-[105px]'"
  >
    <!-- logo -->
    <div class="w-full mb-8">
      <router-link
        ...
        @click="setActive('/')"
      >
        <span class="shrink-0 duration-300">
          <img :src="logoicon" alt="" />
        </span>
        <span :class="{ 'scale-0': !showSidebar }">
    ...
    <div class="flex flex-col gap-[4px]">
      ...
      <div class="whitespace-nowrap">
        <router-link
          :to="{ name: 'dashboard' }"
          class="flex items-center gap-2 group w-full py-4 px-6 text-black-900 hover:bg-green-400 duration-300 hover:text-white rounded-lg"
          :class="
            activePath === 'dashboard'
              ? 'bg-sidbeBarGradient text-white'
              : 'bg-transparentt '
          "
      ...
      <div class="overflow-hidden ">
        <!-- service --> 
        <div
          class="rounded-lg flex items-center justify-between gap-2 group w-full py-4 px-6 hover:bg-green-400 duration-300 hover:text-white cursor-pointer"
          @click="handleDrop('service-category', false)"
          :class="
            activePath == 'service-category'
              ? 'bg-sidbeBarGradient text-white'
              : 'bg-transparent'
          "
        >
        ...
        <div
          ...
          :style="{
            maxHeight:
              activeDropdown == 'service-category' && showSidebar
        ...
        >
          <div class="flex flex-col gap-1">
            <router-link
              ...
              class="shirnk-0 font-poppins text-black-900 hover:text-green-600 py-3 pl-14 pr-6 text-sm"
              :class="routePath === 'service-category' ? 'routeText' : ''"
            >
              Category
            </router-link>
            <router-link
              to="/service-sub-category"
              @click="handleToggleDropdown('service-category', true)"
              class="shirnk-0 font-poppins text-black-900 hover:text-green-600 py-3 pl-14 pr-6 text-sm"
              :class="routePath === 'service-sub-category' ? 'routeText' : ''"
            >
              Sub Category
            </router-link>
          </div>
        ...
        >
          ...
          >
            <path
              ...
              class="group-hover:fill-white duration-300"
              :class="activePath === 'agents' ? 'fill-white' : 'fill-black-900'"
            />
            <path
        ...
        <router-link
          ...
          :class="
            activePath === 'users'
              ...
              : 'bg-transparentt '
          "
          @click="handleToggleDropdown('users', false)"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          >
            <path
              ...
              class="group-hover:fill-white duration-300"
              :class="activePath === 'users' ? 'fill-white' : 'fill-black-900'"
            />
          </svg>
        ...
        >
          ...
          >
            <path
              ...
              class="group-hover:fill-white duration-300"
              :class="
                activePath === 'businesses' ? 'fill-white' : 'fill-black-900'
              "
            />
          </svg>
      ...
      <div class="overflow-hidden">
        ...
        <div
          class="rounded-lg flex items-center justify-between gap-2 group w-full py-4 px-6 hover:bg-green-400 duration-300 hover:text-white cursor-pointer"
          @click="handleDrop('withdraw-request', false)"
          :class="
            activePath == 'withdraw-request'
              ? 'bg-sidbeBarGradient text-white'
              : 'bg-transparent'
          "
        >
        ...
        <div
          ...
          :style="{
            maxHeight:
              activeDropdown == 'withdraw-request' && showSidebar
        ...
        >
          <div class="flex flex-col gap-1 font-poppins">
            <router-link
              ...
              class="shirnk-0 font-poppins text-black-900 hover:text-green-600 py-3 pl-14 pr-6 text-sm"
              :class="routePath === 'withdraw-request' ? 'routeText' : ''"
            >
              Pending
            </router-link>
            <router-link
              ...
              @click="handleToggleDropdown('withdraw-request', true)"
              class="shirnk-0 font-poppins text-black-900 hover:text-green-600 py-3 pl-14 pr-6 text-sm"
              :class="routePath === 'withdraw-history' ? 'routeText' : ''"
            >
              Withdrawal History
            </router-link>
          </div>
      ...
      <div class="whitespace-nowrap">
        <button
          class="flex items-center gap-2 group w-full py-4 px-6 text-black-900 rounded-lg"
          @click="logout"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
...
<script>
import { logo, logotext, logoicon } from "../../../assets/getAssets";
import {
  getActivePath,
  getActiveRoutePath,
} from "../../../utils/getActivePath";
export default {
  data() {
    return {
      routePath: "dashboard",
  ...
  mounted() {
    ...
    this.setActive(this.activePath == "dashboard" ? "/" : this.activePath);
  },
  methods: {
    handleRouting(path) {
    ...
    handleDrop(value, submenu) {
      this.handleSideBar();
      this.handleToggleDropdown(value, submenu);
    },
    logout() {
...
.routeText {
  ...
  font-weight: 400;
  line-height: 20px;
  background: linear-gradient(90deg, #1bb287 -1.39%, #1ec96b 99.86%);
