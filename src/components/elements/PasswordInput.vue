<template>
  <div class="flex items-center border border-neutral-300 h-auto  rounded-lg gap-2 py-3 px-4">
    <input
      :type="isTypeText ? 'text' : 'password'"
      class=" outline-none bg-transparent w-full font-poppins text-base font-normal  leading-[normal]"
      v-model="value"
      v-bind="$attrs"
